...
<html lang="en">
    <head>
        ...
        <title>Forgot Password | Lagos Business School</title>
        <!--Scripts-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-area">
                        ...
                        @endif
                            ...
                            <p>Remenber Password? <a href="{{ route('login') }}">Login</a></p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 py-2 text-center forgotten">
                                    <p>We'll sent a mail to your registered email to reset your password.</p>
                                </div>
                            </div>
                        </form>
                    </div>
